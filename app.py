...
st.markdown("<h1 style='text-align: center; color: black; ''> Text to Handwriting Convertor<br> 🗒️➡️✍️  </h1>",
...
st.sidebar.image('https://cdn-icons-png.flaticon.com/512/10771/10771435.png')
...
if not uploaded_file:
    show_file.info("Please Upload the text/docx/txt file (strictly .docx and .txt) only ")
